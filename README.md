...
This project uses [uv](https://docs.astral.sh/uv/) for fast and reproducible Python management. You don't need to manually install Python or manage virtual environments; uv handles it all. [1, 2]
Install uv:
